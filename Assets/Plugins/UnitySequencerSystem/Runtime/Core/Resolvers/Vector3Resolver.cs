...
namespace HK.UnitySequencerSystem.Resolvers
{
    ...
    [Serializable]
    public sealed class ReferencedTransform : Vector3Resolver
    {
        [SerializeField]
    ...
    [Serializable]
    public sealed class NamedTransform : Vector3Resolver
    {
        [SerializeField]
        private string name;
    ...
    [Serializable]
    public sealed class NamedVector3 : Vector3Resolver
    {
        [SerializeField]
        private string name;
